...
namespace Wuzlstats.Migrations
{
    ...
    partial class Initial
    {
        ...
        {
            get { return "20150519184700_Initial"; }
        }
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Wuzlstats.Models.Game", b =>
                {
                    b.Reference("Wuzlstats.Models.League", "LeagueId");
                });
            ...
            builder.Entity("Wuzlstats.Models.PlayerPosition", b =>
                {
                    b.Reference("Wuzlstats.Models.Game", "GameId");
                    b.Reference("Wuzlstats.Models.Player", "PlayerId");
                });
        }
    }
}
