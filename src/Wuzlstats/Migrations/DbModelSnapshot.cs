    ...
    partial class DbModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("Wuzlstats.Models.Game", b => { b.ForeignKey("Wuzlstats.Models.League", "LeagueId"); });

                builder.Entity("Wuzlstats.Models.Player", b => { b.ForeignKey("Wuzlstats.Models.League", "LeagueId"); });
